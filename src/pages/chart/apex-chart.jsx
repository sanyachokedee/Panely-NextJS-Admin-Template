...
class Chart6 extends React.Component {
  ...
  render() {
    ...
    return <Chart type="rangeBar" options={options} series={series} height={350} />
  }
}
...
class Chart7 extends React.Component {
  ...
  render() {
    ...
    return <Chart type="candlestick" options={options} series={series} height={350} />
  }
}
...
class Chart9 extends React.Component {
  ...
  render() {
    ...
    return <Chart type="scatter" options={options} series={series} height={350} />
  }
}
